...
import ChainInitiatveTracker from "~chain-initiative-tracker";
...
You can use this tool to help run this system at your table. You can also see just the app [here](/chain).

<ChainInitiatveTracker client:visible />
...
- [ ] Credits (find the video you got the idea from (if that even exists, I haven't been able to find it))
